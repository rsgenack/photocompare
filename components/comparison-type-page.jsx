  ...
  return (
    <div className="editorial-container py-12 animate-fadeIn">
          ...
          >
            <div className="p-6">
              <div className="flex items-start mb-4">
                ...
                <Label
                  htmlFor="different"
                  className={`ml-2 text-xl font-bold font-display ${
                    comparisonType === 'different' ? 'text-white' : ''
                  }`}
                >
                  DIFFERENT PHOTOS
                </Label>
              ...
              <p
                className={`ml-6 font-sans ${
                  comparisonType === 'different' ? 'text-white' : 'text-gray-800'
                }`}
              >
          ...
          <div
            className={`cursor-pointer transition-all duration-300 transform hover:scale-105 border-2 border-black ${
              comparisonType === 'versions'
                ? 'bg-tropical_indigo text-white shadow-lg'
                : 'bg-white hover:shadow-md'
            }`}
            ...
            <div className="p-6">
              <div className="flex items-start mb-4">
                ...
                <Label
                  htmlFor="versions"
                  className={`ml-2 text-xl font-bold font-display ${
                    comparisonType === 'versions' ? 'text-white' : ''
                  }`}
                >
              ...
              <p
                className={`ml-6 font-sans ${
                  comparisonType === 'versions' ? 'text-white' : 'text-gray-800'
                }`}
              >
      ...
      <div className="flex justify-center">
        <button
          onClick={handleNext}
          className={`px-12 py-4 text-xl font-bold text-black rounded-full flex items-center bg-yellow_green shadow-md hover:shadow-lg transition-all duration-200 hover:-translate-y-1 ${
            !comparisonType ? 'opacity-50 cursor-not-allowed' : ''
          }`}
        >
          NEXT: UPLOAD PHOTOS
